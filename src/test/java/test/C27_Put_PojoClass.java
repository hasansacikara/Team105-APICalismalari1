...
public class C27_Put_PojoClass extends JsonPlaceHolderBaseUrl {
 ...
 response body’sinin asagida verilen ile ayni oldugunu test ediniz
    ...
    public void put01(){
        ...
        Assert.assertEquals(expData.getBody(),respPojo.getId());
        Assert.assertEquals(expData.getBody(),respPojo.getTitle());
        Assert.assertEquals(expData.getBody(),respPojo.getUserId());
